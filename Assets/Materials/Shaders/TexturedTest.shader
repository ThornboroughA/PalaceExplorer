	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_2_0_g10 = uv_Normal;
				...
				float4 tex2DNode14_g10 = tex2Dlod( _Normal, float4( temp_output_2_0_g10, 0, 0.0) );
				float temp_output_4_0_g10 = 2.0;
				float3 appendResult13_g10 = (float3(1.0 , 0.0 , ( ( tex2Dlod( _Normal, float4( appendResult8_g10, 0, 0.0) ).g - tex2DNode14_g10.g ) * temp_output_4_0_g10 )));
				float2 appendResult9_g10 = (float2(break6_g10.x , ( break6_g10.y + temp_output_25_0_g10 )));
				float3 appendResult16_g10 = (float3(0.0 , 1.0 , ( ( tex2Dlod( _Normal, float4( appendResult9_g10, 0, 0.0) ).g - tex2DNode14_g10.g ) * temp_output_4_0_g10 )));
				float3 normalizeResult22_g10 = normalize( cross( appendResult13_g10 , appendResult16_g10 ) );
				float simplePerlin2D16 = snoise( v.positionOS.xyz.xy*8.79 );
				simplePerlin2D16 = simplePerlin2D16*0.5 + 0.5;
				float3 temp_output_30_0 = ( normalizeResult22_g10 + ( ( simplePerlin2D16 - 0.5 ) * 0.5 ) );
				float2 coords18 = temp_output_30_0.xy * (float)4;
				float2 id18 = 0;
				float2 uv18 = 0;
						 ...
						 ) : SV_Target
			{
				...
				float4 color39 = IsGammaSpace() ? float4(1,0.8683941,0.3726415,0) : float4(1,0.726312,0.1144948,0);
				

				float3 BaseColor = color39.rgb;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float time18 = 0.0;
				float2 voronoiSmoothId18 = 0;
				float2 uv_Normal = v.ase_texcoord.xy * _Normal_ST.xy + _Normal_ST.zw;
				float2 temp_output_2_0_g10 = uv_Normal;
				float2 break6_g10 = temp_output_2_0_g10;
				float temp_output_25_0_g10 = ( pow( 0.5 , 3.0 ) * 0.1 );
				float2 appendResult8_g10 = (float2(( break6_g10.x + temp_output_25_0_g10 ) , break6_g10.y));
...
Node;AmplifyShaderEditor.IntNode;12;-888.7466,407.146;Inherit;False;Constant;_Int0;Int 0;0;0;Create;True;0;0;0;False;0;False;4;0;False;0;1;INT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;30;-519.7466,-196.854;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-1518.747,241.146;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;8.79;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;16;-1177.747,57.14603;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;33;-935.7466,61.14603;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;38;-1499.747,18.14603;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;323,-75;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;TexturedTest;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;40;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;1;638378143679701252;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;638378143559587643;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;0;638378143572847579;_FinalColorxAlpha;0;0;Meta Pass;0;638378143584476553;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;638378143462186785;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.ColorNode;39;-8.419312,-174.1789;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;1,0.8683941,0.3726415,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScaleNode;32;-731.7466,51.14603;Inherit;True;0.5;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;18;-209.7466,38.14603;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.VoronoiNode;40;-217.4193,320.8211;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.DynamicAppendNode;41;26.58069,267.8211;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.NormalVertexDataNode;27;-1539.447,-236.354;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;42;-1024.252,-273.9391;Inherit;False;NormalCreate;0;;10;e12f7ae19d416b942820e3932b56220f;0;4;1;SAMPLER2D;;False;2;FLOAT2;0,0;False;3;FLOAT;0.5;False;4;FLOAT;2;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-1210.747,321.146;Inherit;False;Constant;_Float1;Float 0;0;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=78B53D8514FD6A0A47362E816F7DA34D2B26D25F